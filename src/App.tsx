...
function App() {
  ...
  const [initialBrainstormCode, setInitialBrainstormCode] = useState('');
  ...
  const handleOpenBrainstorm = (code?: string) => {
    if (code) setInitialBrainstormCode(code);
    ...
    return (
      <div className="app">
        ...
        <BrainstormModal
          ...
          initialCode={initialBrainstormCode}
