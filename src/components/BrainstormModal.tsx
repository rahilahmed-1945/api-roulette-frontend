...
export const BrainstormModal: React.FC<BrainstormModalProps> = ({
  ...
  const [username, setUsername] = useState(localStorage.getItem('brainstorm_username') || '');
  ...
  const handleJoinChat = async () => {
    ...
    try {
      localStorage.setItem('brainstorm_username', username);
      ...
      <div className="bg-[#05110a] rounded-2xl border border-white/10 shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex border-b border-white/10">
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-medium transition-all flex items-center justify-center gap-2 ${activeTab === 'create'
          ...
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-medium transition-all flex items-center justify-center gap-2 ${activeTab === 'join'
              ? 'text-primary border-b-2 border-primary bg-primary/5'
              : 'text-slate-400 hover:text-white hover:bg-white/5'
              }`}
          >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0b1f15] border border-white/10 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:ring-2 focus:ring-primary focus:border-transparent transition-all mb-4"
                  />
                  <label className="block text-sm font-medium text-slate-300 mb-2">
                    Room Code
                  </label>
